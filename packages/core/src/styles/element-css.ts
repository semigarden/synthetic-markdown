...
.heading.setext > .inline.setext-break {
  display: none;
}

.heading.setext > .inline.marker {
  display: block;
  width: 100%;
  min-height: 1em;
}

.heading.setext:not(.focused) > .inline.marker {
  display: none;
}
...
.htmlBlock .html-preview {
  display: block;
  max-width: 100%;
}
.htmlBlock:not(.focused) > .inline.marker {
  position: absolute;
  inset: 0;
  opacity: 0;
  width: 100%;
...
.htmlBlock:not(.focused) > .inline.marker .symbolic, .htmlBlock:not(.focused) > .inline.marker .semantic {
  position: absolute;
  inset: 0;
  opacity: 0;
  pointer-events: none;
}
.htmlBlock.focused > .html-preview {
  display: none;
}
.htmlBlock.focused > .inline.marker {
  position: relative;
  opacity: 1;
  width: auto;
  height: auto;
...
.htmlBlock.focused > .inline.marker .symbolic {
  position: relative;
  color: inherit;
  opacity: 1;
  white-space: pre-wrap;
}
.htmlBlock.focused > .inline.marker .semantic {
  display: none;
}
